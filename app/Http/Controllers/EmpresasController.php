...
class EmpresasController extends Controller
{
    ...
    public function show($id_empresa){
        ...
        $model_ser =   Servicio::where('id_empresa',$id_empresa)->get();
        $model_prod =   Producto::where('id_empresa',$id_empresa)->get();
    ...
    public function configuracionMP(Request $request){
        ...
        $fields = array(
            ...
            'redirect_uri' => urlencode('https://www.test-tulocalidad.com.ve/empresas/configuracionMP?id_empresa='.$request->id_empresa),
        );
        $fields_string="";
