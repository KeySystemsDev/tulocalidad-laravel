...
@section('js')
    <script src="{{ asset('public/js/controllers/empresa/empresa_editar.js') }}"></script>
@endsection
...
<div ng-controller="EditarEmpresaController">
    ...
    <div ng-init="img='/uploads/empresas_mid/{{$empresa->icon_empresa}}'"></div>
			...
			<div class="row">
                ...
                <div class="col-lg-12">
              	...
              	<div class="col-lg-12">
                	<section class="panel">
                		<header class="panel-heading center">
            				<button class="btn btn-success btn-lg fa fa-check" type="button" ng-click="checkMe()"> Actualizar Registro</button>
      					</header>
      				</section>
      			</div>
