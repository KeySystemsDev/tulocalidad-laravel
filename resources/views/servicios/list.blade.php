		                        ...
		                        <div class="single-products">
		                            <div class="productinfo text-center" id="productinfo">
		                                ...
		                                <div class="row">
			                                ...
			                                <div class="col-md-2" ng-if="item.habilitado_servicio==1">
			                                	<a href="[[ url + '/empresas/' + item.id_empresa + '/servicios/' + item.id_servicio + '/deshabilitar' ]]" class="btn btn-default btn-deshabilitar-hover" data-toggle="tooltip" data-title="Deshabilitar"><i class="fa fa-thumbs-o-down"></i></a>
			                            	</div>	
			                                <div class="col-md-2" ng-if="item.habilitado_servicio==0">
			                                	<a href="[[ url + '/empresas/' + item.id_empresa + '/servicios/' + item.id_servicio + '/habilitar' ]]" class="btn btn-default btn-success-hover" data-toggle="tooltip" data-title="Habilitar"><i class="fa fa fa-thumbs-o-up"></i></a>
			                            	</div>	
			                                <div class="col-md-2">
			                                	<a href="[[ url + '/empresas/' + item.id_empresa + '/servicios/' + item.id_servicio + '/destroy']]" class="btn btn-default btn-danger-hover" data-toggle="tooltip" data-title="Eliminar"><i class="fa fa-trash"></i></a>
			                            	</div>				                            	
			                            </div>			                            
		                            	<br>
		                            </div>
		                            <div id="btn-producto-action">
	                            		<div class="acti-btn-box">
	                            			<h4><span class="label label-info" ng-show="item.habilitado_servicio==1"><i class="fa fa-thumbs-o-up"></i> Activo</span></h4>
	                                		<h4><span class="label label-warning" ng-show="item.habilitado_servicio==0"><i class="fa fa-thumbs-o-down"></i> Inactivo</span></h4>
	                            		</div>
	                                </div>
		                        </div>
		                    </div>
